...
export const THEME_DIMENSIONS = {
  theme_philosophy: {
    name: '核心哲理与人生主题',
    prompt: '请从核心哲理与人生主题的角度分析这张插图，描述其传达的人生智慧、价值观念、成长启示等深层内涵。'
  },
  action_process: {
    name: '行动过程与成长',
  ...
  edu_value: {
    name: '阅读教育价值',
    prompt: '请从阅读教育价值的角度分析这张插图，描述其教育意义、知识传递、学习启发、认知发展等教育功能。'
  },
  learning_strategy: {
    name: '阅读学习策略',
    prompt: '请从阅读学习策略的角度分析这张插图，描述阅读方法、学习技巧、思维训练、理解策略等学习相关内容。'
  },
  creative_play: {
    name: '创意玩法与想象力',
    prompt: '请从创意玩法与想象力的角度分析这张插图，描述创意元素、想象空间、游戏性、趣味性等激发创造力的内容。'
  },
  scene_visuals: {
    name: '场景氛围与视觉元素',
    prompt: '请从场景氛围与视觉元素的角度分析这张插图，描述画面构图、色彩运用、环境氛围、视觉风格等艺术表现。'
  }
};
